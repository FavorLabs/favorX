...
var fixtureChunks = map[string]boson.Chunk{
	...
	"0033": boson.NewChunk(
		boson.MustParseHexAddress("0033153ac8cfb0c343db1795f578c15ed8ef827f3e68ed3c58329900bf0d7276"),
	...
	"02c2": boson.NewChunk(
		boson.MustParseHexAddress("02c2bd0db71efb7d245eafcc1c126189c1f598feb80e8f14e7ecef913c6a2ef5"),
	...
	"7000": boson.NewChunk(
		boson.MustParseHexAddress("70002115a015d40a1f5ef68c29d072f06fae58854934c1cb399fcb63cf336127"),
...
func GenerateTestRandomChunk() boson.Chunk {
...
// addressed chunk.
func GenerateTestRandomInvalidChunk() boson.Chunk {
	data := make([]byte, boson.ChunkSize)
	_, _ = rand.Read(data)
...
func GenerateTestRandomChunks(count int) []boson.Chunk {
	chunks := make([]boson.Chunk, count)
	for i := 0; i < count; i++ {
...
func FixtureChunk(prefix string) boson.Chunk {
